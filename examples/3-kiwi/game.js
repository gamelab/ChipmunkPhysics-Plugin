...
State.preload = function() {
	...
	//kiwi.js
	this.addImage('k', '../../assets/kiwi-logo/k.png');
	this.addImage('i', '../../assets/kiwi-logo/i.png');
	this.addImage('w', '../../assets/kiwi-logo/w.png');
	this.addImage('dot', '../../assets/kiwi-logo/..png');
	this.addImage('j', '../../assets/kiwi-logo/j.png');
	this.addImage('s', '../../assets/kiwi-logo/s.png');
	this.addImage('underline', '../../assets/kiwi-logo/underline.png');


	//Logo
	this.addImage('bomb', '../../assets/kiwi-logo/bomb.png');
	this.addImage('castle', '../../assets/kiwi-logo/castle.png');
	this.addImage('controller-1', '../../assets/kiwi-logo/controller-1.png');
	this.addImage('controller-2-left', '../../assets/kiwi-logo/controller-2-left.png');
	this.addImage('controller-2-right', '../../assets/kiwi-logo/controller-2-right.png');
	this.addImage('crown', '../../assets/kiwi-logo/crown.png');

	this.addImage('fingers', '../../assets/kiwi-logo/fingers.png');

	this.addImage('heart-1', '../../assets/kiwi-logo/heart.png');
	this.addImage('heart-2', '../../assets/kiwi-logo/heart-2.png');
	this.addImage('jigsaw-1', '../../assets/kiwi-logo/jigsaw.png');
	this.addImage('jigsaw-2', '../../assets/kiwi-logo/jigsaw-2.png');

	this.addImage('key', '../../assets/kiwi-logo/key.png');

	this.addImage('lighting-1-left', '../../assets/kiwi-logo/lighting-bolt-left.png');
	this.addImage('lighting-1-right', '../../assets/kiwi-logo/lighting-bolt-right.png');
	this.addImage('lighting-2-left', '../../assets/kiwi-logo/lighting-bolt-2-left.png');
	this.addImage('lighting-2-right', '../../assets/kiwi-logo/lighting-bolt-2-right.png');
	this.addImage('lighting-3', '../../assets/kiwi-logo/lighting-bolt-3.png');

	this.addImage('mouse', '../../assets/kiwi-logo/mouse.png');
	this.addImage('pacman', '../../assets/kiwi-logo/pacman.png');
	this.addImage('rocket', '../../assets/kiwi-logo/rocket.png');
	this.addImage('shield', '../../assets/kiwi-logo/shield.png');
	this.addImage('spade', '../../assets/kiwi-logo/spade.png');
	this.addImage('speech', '../../assets/kiwi-logo/speech-bubble.png');

	this.addImage('sword', '../../assets/kiwi-logo/sword.png');
	this.addImage('sword-2-left', '../../assets/kiwi-logo/sword-2-left.png');
	this.addImage('sword-2-right', '../../assets/kiwi-logo/sword-2-right.png');
